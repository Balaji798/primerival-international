...
const commitmentCards = [
  {
    ...
    description: 'Primerival International excels in providing top-notch latex products.',
    icon: '🏆',
  ...
  },
  {
    ...
    description: 'As a leading B2C manufacturer of latex gloves, pillows, and mattresses, Primerival International serves sectors like healthcare, hospitality, and home comfort, ensuring superior quality and technical consistency. Our pledge to quality and innovation drives our success.',
    icon: '🚀',
  ...
  },
  {
    ...
    description: 'Primerival International envisions a world where comfort products are crafted with integrity, shared with care, and trusted by all. We aim to be more than a supplier, serving as a partner that inspires confidence through quality, transparency, and a commitment to better comfort solutions for future generations.',
    icon: '🌟',
  ...
  },
  {
    ...
    description: 'At Primerival International, quality is more than a promise. It\'s built into every stage of our process. From raw material sourcing to final delivery, we ensure safety, consistency, and transparency so you can trust every product that carries our name.',
    icon: '✓',
