    ...
    <>
      ...
      >
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <nav 
            className={`relative backdrop-blur-xl bg-gradient-to-r from-[#800000]/95 via-[#fa3035]/95 to-[#800000]/95 rounded-2xl shadow-2xl border border-white/20 transition-all duration-300 ${
              isScrolled 
